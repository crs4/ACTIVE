        ...
        return {
            ...
            link: function (scope, element) {
				...
				for(var i = 0, l = galleryElements.length; i < l; i++) {
					...
					galleryElements[i].onclick = viewerService[0];//.onThumbnailsClick;
				}

				var hashData = viewerService[1]();//.photoswipeParseHash();
				
				if(hashData.pid > 0 && hashData.gid > 0) {
					viewerService[2](hashData.pid - 1 ,  galleryElements[ hashData.gid - 1 ], true );
					//viewerService.openPhotoSwipe( hashData.pid - 1 ,  galleryElements[ hashData.gid - 1 ], true );
				}
