...
def identification(file_properties):
    print "diarization and identification"
    java="java -Xmx2048m " #da definire in base alla macchina
    java_classpath=" -classpath ./lium_spkdiarization-8.4.1.jar " 
    commandline=java+java_classpath+" it.crs4.active.identificatio.Identification2 "+"./data/properties/"+file_properties 
    print "identification -- command \n"
    print commandline
    start_subprocess(commandline)


def only_identification(file_properties):
    print "only identification"
    java="java -Xmx2048m " #da definire in base alla macchina
    java_classpath=" -classpath ./lium_spkdiarization-8.4.1.jar " 
    commandline=java+java_classpath+" it.crs4.active.identificatio.DBScore"+"./data/properties/"+file_properties 
    print "only_identification -- command \n"
    print commandline
    start_subprocess(commandline)
