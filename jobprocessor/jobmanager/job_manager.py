...
# NB: decidere se ointrodurre nuna lock in tutte le operazioni sulle code
# evitare la situazione in cui si ha un job fuori dalla coda e 
# nello stesso istante si richiede la stessa.
