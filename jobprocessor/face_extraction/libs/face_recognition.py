...
def recognize_face_from_histogram(face, face_models, params, show_results):
    ...
    train_histograms = face_models["histograms"]
    
    train_labels = face_models["labels"]
...
def recognize_face(face, face_models, params, show_results):
    ...
    if(USE_ONE_FILE_FOR_FACE_MODELS):
        ...
        result = recognize_face_from_histogram(
        face, face_models, params, show_results)
