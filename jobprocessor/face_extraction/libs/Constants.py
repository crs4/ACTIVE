...
ACTIVE_ROOT_DIRECTORY="/var/spool/active/data" + os.sep
...
DB_MODELS_PATH = ACTIVE_ROOT_DIRECTORY + 'tools' + os.sep + 'Models'
...
TEST_CONFIGURATION_FILE_PATH = ACTIVE_ROOT_DIRECTORY +  'test' + os.sep + 'Test module' + os.sep + 'src' + os.sep + 'TestConfiguration.yml'
TEST_VIDEO_PATH = r'C:\Active\RawVideos' +  os.sep + TEST_VIDEO_NAME + '.mpg'
TMP_FILE_PATH = ACTIVE_ROOT_DIRECTORY + 'tools' + os.sep + 'aligned_face%s.bmp'
TMP_FRAME_FILE_PATH = ACTIVE_ROOT_DIRECTORY + 'tools' + os.sep + 'frame.bmp'
