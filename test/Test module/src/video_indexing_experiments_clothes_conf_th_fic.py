...
clothes_bbox_size_list = ((1.0, 2.0),)
    ...
    for clothes_bbox_size in clothes_bbox_size_list:
        ...
        for use_3_bboxes in use_3_bboxes_list:
            ...
            for conf_threshold in conf_threshold_list:
                ...
                if((clothes_bbox_size[1] == 1.0) and (use_3_bboxes)):
                ...
                params[CODE_VERSION_KEY] = 318# Palladium
