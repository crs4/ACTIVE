...
for lbp_parameters in lbp_parameters_list:
    ...
    for num_people in [5,10,20,40,80]:
        ...
        path = r'C:\Users\Maurizio\Documents\Dataset\Videolina-960I-80P-whole_images\Face models'
        ...
        #params[c.TEST_SET_PATH_KEY] = r'C:\Users\Maurizio\Documents\Dataset\Videolina-80I-80P-whole_images\5 persone' # Portatile MP
