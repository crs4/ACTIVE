...
# video_idx_path = r'C:\Active\Person_tracking'  # Palladium
code_version = 388
...
# TODO CHANGE
aligned_faces_path = r'C:\Users\Maurizio\Documents\Aligned faces'  # Portatile MP
...
# TODO CHANGE
video_idx_results_path = r'C:\Users\Maurizio\Documents\Video indexing\Person tracking\Results'  # Portatile MP
# video_idx_results_path = r'C:\Active\Risultati test\Person tracking'  # Palladium

video_idx_results_file_name = 'Person_tracking'
...
# TODO CHANGE
tesseract_parent_dir_path = r'C:\Users\Maurizio\Documents\Progetto ACTIVE\face_extractor\tools'  # Portatile MP
...
merge_caption_and_faces_results = False
...
for resource_path in resource_paths:
    ...
    params = {ce.CODE_VERSION_KEY: code_version,
              ...
              c.MERGE_CAPTION_AND_FACE_RESULTS_KEY: merge_caption_and_faces_results,

              c.USE_PERSON_TRACKING_KEY: use_person_tracking,
              c.PERSON_TRACKING_CLOTHES_BBOX_HEIGHT_KEY: person_tracking_clothes_bbox_height,
              c.PERSON_TRACKING_CLOTHES_BBOX_WIDTH_KEY: person_tracking_clothes_bbox_width,
              c.PERSON_TRACKING_HSV_CHANNELS_NR_KEY: person_tracking_hsv_channels_nr,
              c.PERSON_TRACKING_MIN_CORR_PCT_KEY: person_tracking_min_corr_pct,
              c.PERSON_TRACKING_NECK_HEIGHT_KEY: person_tracking_neck_height,
              c.PERSON_TRACKING_USE_MASK_KEY: person_tracking_use_mask
              }

    # TODO CHANGE
    if resource_id == 'fic.02.mpg':
        # TODO CHANGE
        params[ce.ANNOTATIONS_PATH_KEY] = r'C:\Users\Maurizio\Documents\Dataset\Annotazioni\Videolina-15V\fic.02\Simple annotations'  # Portatile MP
        # params[ce.ANNOTATIONS_PATH_KEY] = r'C:\Active\Dataset\Annotazioni\Videolina-15V\fic.02\Simple annotations'  # Palladium
    ...
    params_file_path = r'C:\Users\Maurizio\Documents\video_indexing_experiments_person_tracking.yml'  # Portatile MP
    # params_file_path = r'C:\Active\Params\video_indexing_experiments_person_tracking.yml' # Palladium
