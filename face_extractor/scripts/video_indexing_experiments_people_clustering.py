...
use_aggr = False
use_aligned_face_in_tracking = False
use_clothing = True
use_maj_rule = True
...
use_3_bboxes_list = [True]
use_dom_color_list = [False]
conf_threshold_list = [14]
# use_3_bboxes_list = [False, True] # TODO UNCOMMENT
# use_dom_color_list = [False, True] # TODO UNCOMMENT
# conf_threshold_list = range(10, 51, 20)
        ...
        for use_dom_color in use_dom_color_list:
            ...
            for conf_threshold in conf_threshold_list:
                ...
                if resource_id == 'fic.02.mpg':
                    params[ce.VIDEO_PARAMS_FILE_PATH_KEY] = r'C:\Users\Maurizio\Documents\Video indexing\Face extraction\fic.02.mpg\Face extraction\fic.02.mpg_parameters.YAML'
                    params[ce.FRAMES_PATH_KEY] = r'C:\Users\Maurizio\Documents\Video indexing\Face extraction\fic.02.mpg\Face extraction\Frames'
                    params[ce.FACES_PATH_KEY] = r'C:\Users\Maurizio\Documents\Video indexing\Face extraction\fic.02.mpg\Face extraction\Face detection\Aligned faces'
                    params[ce.FACE_TRACKING_FILE_PATH_KEY] = r'C:\Users\Maurizio\Documents\Video indexing\Face extraction\fic.02.mpg\Face extraction\Face tracking\fic.02.mpg.YAML'
                    params[ce.FACE_MODELS_DIR_PATH_KEY] = r'C:\Users\Maurizio\Documents\Video indexing\Face extraction\fic.02.mpg\Face extraction\Face models'
                    params[ce.ANNOTATIONS_PATH_KEY] = r'C:\Users\Maurizio\Documents\Dataset\Annotazioni\Videolina-15V\fic.02\Simple annotations'
