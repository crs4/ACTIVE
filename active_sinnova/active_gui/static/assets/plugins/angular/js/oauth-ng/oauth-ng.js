...
var accessTokenService = angular.module('oauth.accessToken', ["ngCookies"]);

accessTokenService.factory('AccessToken', ['Storage', '$rootScope', '$location', '$interval', '$cookies', function(Storage, $rootScope, $location, $interval, $cookies){
	...
	$cookies.put("ciccio", service.token.access_token, {expires:service.token.expires_at});
    };
...
directives.directive('oauth', [
  ...
  definition.link = function postLink(scope, element, attrs) {
    ...
    var initAttributes = function() {
      ...
      scope.tokenPath     = scope.tokenPath     || '/o/token';//'/oauth/token';
