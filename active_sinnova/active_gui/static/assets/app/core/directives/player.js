        ...
        return {
            ...
            controller: function ($scope) {
				...
				if($localStorage.token)
					var url = appConfig.coreApiUrl + "items/file/" + $scope.currentItem.id + "/?type=preview&token=" + $localStorage.token.access_token;
				else
					var url = appConfig.coreApiUrl + "items/file/" + $scope.currentItem.id + "/?type=preview&token=123456";
