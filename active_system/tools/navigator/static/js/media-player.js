...
$(document).ready(function(){
	...
	$("#icons img").click(function(){
			...
			if(imgClicked != "/static/icons/voloff.png" && imgClicked != "/static/icons/volon.png" ){
			...
			if( imgClicked == "/static/icons/play.png"){
				
				mediaPlayer.play();			
					
			}
			else if ( imgClicked == "/static/icons/pause.png"){
				mediaPlayer.pause();					
			}
			else if ( imgClicked == "/static/icons/stop.png"){
				mediaPlayer.pause();
				mediaPlayer.currentTime = 0;				
			}
			if(imgClicked == "/static/icons/volon.png" ){
				mediaPlayer.muted = true;	
				$("#icons img:nth-child(4)").attr('src',"/static/icons/voloff.png");
				$("#icons img:nth-child(4)").effect("highlight");
				return false;
			}
			if(imgClicked == "/static/icons/voloff.png" ){
				mediaPlayer.muted = false;
				$("#icons img:nth-child(4)").attr('src',"/static/icons/volon.png");
				$("#icons img:nth-child(4)").effect("highlight");
				return false;
			}
