"""
This module is used to define the data model for users information.
Some additional methods has been created in order to provide a full access
to user fields.
"""
...
class ActiveUser(models.Model):
    """
    This model has been defined in order to manage all
