...
with the provided method and a short description for each one:
    ...
    - GET     /api/keywords/search/image/landscape        retrieve all ImageItem objects with keyword 'landscape'
    - GET     /api/keywords/search/video/landscape,lake   retrieve all VideoItem objects with both keyword 'landscape' and 'lake'
"""
