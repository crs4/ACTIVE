...
class JobManager:
    ...
    def addJob(self, job):
        ...
        @type job: Job
        """
        logger.debug('Adding a new job to execution queue - ' + job.id)
        job.status = "QUEUED"
    ...
    def cleanJobs(self):
        ...
        """
        logger.debug('Requested  cleaning of Job\'s queues')
    ...
    def getAllJobs(self):
        ...
        """
        logger.debug('Requested all Job objects')
    ...
    def getJobs(self, status):
        ...
        """
        logger.debug('Requested all Job objects with status ' + status)
    ...
    def getJob(self, job_id):
        ...
        """
        job_id = str(job_id)
        logger.debug('Requested Job object ' + job_id)
