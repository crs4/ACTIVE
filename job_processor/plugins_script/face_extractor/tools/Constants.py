...
CLASSIFIERS_DIR_PATH = r'/usr/share/opencv/haarcascades' # Maurizio Pintus - cambiato per lo script
...
VIDEO_INDEXING_PATH = os.path.join(settings.MEDIA_ROOT, 'video_indexing') # r'C:\Users\Maurizio\Documents\Face summarization\Test' # Maurizio Pintus # modificato per gli script
...
VIDEO_INDEXING_EXPERIMENT_RESULTS_FILE_NAME = 'ID-TEST-1000-'
